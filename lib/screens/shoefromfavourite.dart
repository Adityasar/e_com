...
class FavouriteShoePage extends StatelessWidget {
  const FavouriteShoePage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final shoe = ModalRoute.of(context)!.settings.arguments
                  ...
                  Card(
                    ...
                    child: CarouselSlider(
                        ...
                        options: CarouselOptions(
                            height: 200, initialPage: 0, viewportFraction: 1)),
                  )
                ],
              ),
            ),
